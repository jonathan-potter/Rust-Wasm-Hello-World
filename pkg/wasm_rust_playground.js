...
export class Integration {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Integration.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_integration_free(ptr);
    }
    /**
    */
    constructor() {
    ...
    */
    tick(time) {
        wasm.integration_tick(this.ptr, time);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('wasm_rust_playground_bg.wasm', import.meta.url);
    }
    const imports = getImports();
